...
import { atcGetCanhBaoSinhViensLopHoc, atcPostCanhBaoSinhViensLopHoc } from "../../../redux/actions/GiangVien";
...
export default function CanhBaoSinhVien(props) {  
  ...
  const state = useSelector((state) => state.canhBaoSinhVienOfGiangVienReducer,shallowEqual);
  useEffect(() => {
  ...
  const postCanhBao = (e)=>{
    e.preventDefault(); 
     if(!window.confirm("Việc gởi cảnh này sẽ gởi sms cho sinh viên và phụ huynh, bạn đã chắc chắn?")){
       return;
     }
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div
              className="tab-pane fade canhbao-form"
              role="tabpanel"
